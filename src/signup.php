...
<form class="form container" method="post">
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="text" class="input" placeholder="Enter your Email" name="username">
      </div>
    ...
    <div class="flex-column">
      ...
      <div class="flex-column">
        ...
        <button class="button-submit" name="button-submit">Create Account</button>
        <a href="login.php" class="p text-decoration-none">Already have an account? <span class="span">login</span></a>
</form>
